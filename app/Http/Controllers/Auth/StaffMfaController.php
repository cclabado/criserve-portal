...
class StaffMfaController extends Controller
{
    ...
    protected function redirectForRole(string $role): RedirectResponse
    {
        return match ($role) {
            ...
            'budget_officer' => redirect()->route('budget-officer.dashboard'),
            'budget_approver' => redirect()->route('budget-approver.dashboard'),
            'accounting_officer' => redirect()->route('accounting-officer.dashboard'),
            'accounting_approver' => redirect()->route('accounting-approver.dashboard'),
            'cash_officer' => redirect()->route('cash-officer.dashboard'),
            'cash_approver' => redirect()->route('cash-approver.dashboard'),
            'finance_director' => redirect()->route('finance-director.dashboard'),
