...
<main class="p-8 max-w-7xl mx-auto space-y-6">
    ...
    <section class="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
        <form method="GET" action="{{ route('approving.gl-program-amount-approvals') }}" class="grid gap-4 md:grid-cols-3">
            <div>
                        ...
                        <tr class="hover:bg-slate-50/70">
                            <td class="px-5 py-4">
                                ...
                                <p class="mt-1 text-xs text-slate-500">
                                    Accounting approved {{ $application->gl_accounting_approved_at?->format('M d, Y h:i A') ?? $application->updated_at?->format('M d, Y h:i A') }}
                                </p>
                            </td>
                            <td class="px-5 py-4">
                            ...
                            <td class="px-5 py-4">
                                <span class="inline-flex rounded-full border border-sky-200 bg-sky-50 px-3 py-1 text-[11px] font-bold uppercase tracking-[0.16em] text-sky-700">
