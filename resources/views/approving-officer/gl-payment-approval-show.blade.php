...
<main class="space-y-6" x-data="{ activeTab: 'client' }">
    ...
    <section class="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
        ...
        <article class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
            ...
            <div class="mt-3">
                <span class="inline-flex rounded-full border px-3 py-1 text-[11px] font-black uppercase tracking-[0.16em] {{ $paymentStatusClass }}">
                    {{ $paymentStatusLabel }}
                </span>
            </div>
        </article>
    ...
    <section x-show="activeTab === 'decision'" x-cloak class="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
        <div class="space-y-6">
            <section class="rounded-3xl border border-slate-200 bg-slate-50 p-5">
                <h2 class="text-2xl font-black text-sky-950">GL Payment Processor Endorsement</h2>
