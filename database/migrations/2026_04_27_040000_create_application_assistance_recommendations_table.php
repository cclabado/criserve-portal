...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('application_assistance_recommendations', function (Blueprint $table) {
            ...
            $table->foreignId('assistance_subtype_id');
            ...
            $table->foreign('assistance_subtype_id', 'aar_subtype_fk')->references('id')->on('assistance_subtypes')->cascadeOnDelete();
            $table->foreign('assistance_detail_id', 'aar_detail_fk')->references('id')->on('assistance_details')->nullOnDelete();
            $table->foreign('mode_of_assistance_id', 'aar_mode_fk')->references('id')->on('mode_of_assistances')->cascadeOnDelete();
