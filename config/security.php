...
return [
    ...
    'mfa' => [
        ...
        'required_roles' => array_values(array_filter(array_map(
            'trim',
            explode(',', (string) env('MFA_REQUIRED_ROLES', 'admin,social_worker,approving_officer,reporting_officer,technical_staff,admin_staff,budget_officer,accounting_officer,accounting_approver,cash_officer,cash_approver,service_provider,gl_payment_processor,referral_institution,referral_officer'))
        ))),
    ],
];
